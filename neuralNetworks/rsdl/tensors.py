...
class Tensor:
    ...
    def __iadd__(self, other) -> 'Tensor':
        ...
        # Hint use _add function
        # self += other
        updated_tensor = _add(self, ensure_tensor(other))
        self.data = updated_tensor.data
        self.requires_grad = updated_tensor.requires_grad
        self.depends_on = updated_tensor.depends_on
        return self
    ...
    def __imul__(self, other) -> 'Tensor':
        ...
        # Hint use _mul function
        # self *= other
        updated_tensor = _mul(self, ensure_tensor(other))
        self.data = updated_tensor.data
        self.requires_grad = updated_tensor.requires_grad
        self.depends_on = updated_tensor.depends_on
        return self
    ...
    def __getitem__(self, idcs):
        ...
        return _tensor_slice(self, idcs=idcs)
    
    def __neg__(self, idcs):
        # TODO: implement neg (-)
        # Hint use -_tensor_neg function
        neg_tensor = _tensor_neg(self)
        return _tensor_slice(neg_tensor, idcs=idcs)
...
def _tensor_log(t: Tensor) -> Tensor:
    ...
    if req_grad:
        def grad_fn(grad: np.ndarray):
            return grad * (np.ones_like(t.data) / t.data)
